...
ChaineMontagne3D::ChaineMontagne3D(double a,double b) : ChaineMontagne(a,b) {}
ChaineMontagne3D::ChaineMontagne3D(vector<ChaineMontagne*> a, double ab, double b)
: ChaineMontagne(a,ab,b) 
{}

void ChaineMontagne3D::dessine() const {
